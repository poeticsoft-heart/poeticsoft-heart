<?php
/**
 * Clase para configurar dinámicamente PHPMailer basándose en las credenciales guardadas.
 *
 * @package PoeticsoftHeart\Credentials\Integrations
 */
